...
export const LOCAL_TEMPLATES: TemplateRow[] = [
  ...
  },
  {
    ...
    name: "Lavender Dream",
    hex_color: "#4B0082",
    border_class: "border-secondary-foreground",
    accent_class: "bg-secondary-foreground",
    paper_class: "bg-violet-50",
    category: "classic",
    sort_order: 2,
  },
  {
    ...
    accent_class: "bg-tertiary",
    paper_class: "bg-sky-50",
    category: "classic",
    sort_order: 3,
  },
  {
    ...
    name: "Mint Pop",
    hex_color: "#10B981",
    border_class: "border-emerald-400",
    accent_class: "bg-emerald-500",
    paper_class: "bg-emerald-50",
    category: "classic",
    sort_order: 4,
  },
  {
    ...
    accent_class: "bg-amber-400",
    paper_class: "bg-yellow-50",
    category: "classic",
    sort_order: 5,
  },
  {
  ...
  },
  {
    ...
    name: "Lime Glow",
    hex_color: "#84CC16",
    border_class: "border-lime-400",
    accent_class: "bg-lime-500",
    paper_class: "bg-lime-50",
    category: "classic",
    sort_order: 8,
  },
  {
    ...
    name: "Mono Star",
    hex_color: "#111827",
    border_class: "border-gray-900",
    accent_class: "bg-gray-900",
    paper_class: "bg-gray-50",
    category: "classic",
    sort_order: 9,
  },
];
...
export async function fetchTemplates(): Promise<TemplateRow[]> {
  const { data, error } = await supabase
    .from("templates")
    .select(
      "id, name, hex_color, border_class, accent_class, paper_class, category, sort_order",
    )
    .eq("is_active", true)
