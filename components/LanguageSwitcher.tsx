    ...
    <div className="relative">
      <button
        ...
        className={`
          ...
          transition-colors hover:bg-secondary/50 hover:text-primary
          rounded-lg sm:px-3
      ...
      {/* Dropdown menu */}
      <div
        className="absolute right-0 mt-1 w-40 rounded-xl bg-background shadow-2xl border border-border py-2 z-50 hidden group-hover:block hover:block"
        style={{ display: 'none' }}
...
// Simpler dropdown version that works on click
  ...
  return (
    <div className="relative">
      <button
        ...
        className="inline-flex items-center gap-1.5 px-2 py-1.5 text-xs font-semibold text-muted-foreground transition-colors hover:bg-secondary/50 hover:text-primary rounded-lg sm:px-3"
      >
        <Globe size={16} />
