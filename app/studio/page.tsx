      ...
      <main className="flex-1">
        <div className="max-w-[1160px] mx-auto px-6 py-8">
          <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_0.9fr] gap-6">
            {/* Camera Preview Card - Left column: video only */}
            <div className="bg-white border border-[#F0D9E6] rounded-2xl overflow-hidden max-h-[70vh]">
              <div 
                className="relative bg-gradient-to-br from-[#3a2a3a] via-[#8899bb] to-[#dfc9b0] max-h-[70vh]"
            ...
            {/* Right Column Content - Camera Controls + Frames Preview */}
